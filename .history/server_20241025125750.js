...
//loo
  ...
  try {
    ...
    sendCheckinNotification(userEmail, "Sk!p Checkin Complete", `Hello here, Your checkin status has been updated, here is your check Id is: ${checkinData.checkinId}. `)
  } catch (error) {
