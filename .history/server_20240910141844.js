...
app.put('/decline_chat_req/:request_id', authenticate, asyncHandler(async (req, res) => {
  const requestId = req.params.request_id;
  ...
  res.json(updatedChatRequest.value);
}));
...
app.get('/get_messages/:chatRoomId', authenticate, asyncHandler(async (req, res) => {
