...
app.post("/checkin_user", asyncHandler(async(req, res)=>{
  const {attendeeId, user,userEmail } = req.body
  ...
  try {
    ...
    sendCheckinNotification(userEmail, "Sk!p Checkin Complete", `Hello here, Your checkin status has been updated, here is your checkin Id: ${checkinData.checkinId}. `)
  } catch (error) {
