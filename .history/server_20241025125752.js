...
app.post("/checkin_user", asyncHandler(async(req, res)=>{
  const {attendeeId, userEmail} = req.body
...
//loo
  ...
  try {
    ...
    sendCheckinNotification(userEmail, "Sk!p Checkin Complete", `Hello here, Your checkin status has been updated, here is your checkin Id is: ${checkinData.checkinId}. `)
  } catch (error) {
